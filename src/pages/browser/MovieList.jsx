    ...
    return (
        <div className='flex-col relative px-10 group'>
            <h1 
                ...
                className='text-5xl font-bold absolute left-10 top-40 text-white hidden  cursor-pointer select-none group-hover:block hover:scale-150'>
         <i className="fa-solid fa-chevron-left"></i>
            </h1>
            <h1 
                onClick={handleScrollRight}
                className='text-5xl font-bold absolute right-10 top-40 text-white hidden  cursor-pointer select-none group-hover:block hover:scale-150'>
